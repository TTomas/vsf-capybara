...
<script>
import { SfHeading, SfIcon, SfProperty } from '@storefront-ui/vue';
...
//hk import { ProductAttribute } from '@vue-storefront/core/modules/catalog/components/ProductAttribute';
