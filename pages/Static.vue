  ...
  data () {
    return {
      navigation: [
        ...
        { title: i18n.t('Legal notice'), link: getPathForStaticPage('/legal'), isCms: true },
        { title: i18n.t('Store locator'), link: getPathForStaticPage('/store-locator'), isCms: true },
        { title: i18n.t('Delivery'), link: getPathForStaticPage('/delivery'), isCms: true },
        { title: i18n.t('Privacy policy'), link: getPathForStaticPage('/privacy'), isCms: true },
        { title: i18n.t('Size guide'), link: getPathForStaticPage('/size-guide'), isCms: true },
